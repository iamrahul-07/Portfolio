...
const skills = [
  ...
  { name: "React Icons", icon: <FaReact className="text-gray-800" /> },
];
...
const Skills = () => {
  return (
    <section
      id="skills"
      className="min-h-screen flex flex-col justify-center bg-gradient-to-r from-green-50 to-gray-100 pt-12 sm:pt-16 pb-16 sm:pb-20"
    >
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-4 sm:px-6 mb-12 sm:mb-16">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-3 sm:mb-4">
            Currently, I specialize in <strong>Frontend Development</strong> with a focus on{" "}
            <strong>React.js</strong>, <strong>TailwindCSS</strong>, and building responsive,
            modern interfaces.
          </p>
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
            I also work with <strong>Java</strong> and <strong>Python</strong> for problem solving
            and Data Structures. Soon, I will explore <strong>Backend Development</strong> to
        ...
        >
          <img
            ...
            className="w-3/4 sm:w-full max-w-sm sm:max-w-md md:max-w-lg"
          />
        </motion.div>
      </div>
      ...
      >
        {skills.map((skill, index) => (
          <motion.div
            key={index}
            className="bg-white rounded-2xl shadow-md p-4 sm:p-6 flex flex-col items-center justify-center text-center cursor-pointer border border-gray-100"
